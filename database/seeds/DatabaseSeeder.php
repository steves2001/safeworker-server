...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		DB::table('announcements')->insert([
            ...
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'Safeguarding', 'content' => '<ul style="padding-left: 20px;"><li>Safeguarding Team<br>safeguarding@lincolncollege.ac.uk<br>01522 86495 or 01522 864219<br>during office hours<br>&nbsp;</li><li>Out of hours duty emergency teams<br>01522 782333 (Lincolnshire)<br>03004 564546 (Nottinghamshire)<br>&nbsp;</li><li>Lincolnshire or Nottinghamshire Police<br>Telephone 101 to report a crime<br>Telephone 999 in an emergency</li></ul>', 'visible' => 'Y'],
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'Hate Crime', 'content' => '<ul style="padding-left: 20px;"><li>Safeguarding Team<br>safeguarding@lincolncollege.ac.uk<br>01522 86495 or 01522 864219<br>during office hours<br>&nbsp;</li><li>Out of hours duty emergency teams<br>01522 782333 (Lincolnshire)<br>03004 564546 (Nottinghamshire)<br>&nbsp;</li><li>Lincolnshire or Nottinghamshire Police<br>Telephone 101 to report a crime<br>Telephone 999 in an emergency<br>&nbsp;</li><li><a href="https://www.stophateuk.org/">Stop Hate UK</a></li></ul>', 'visible' => 'Y'],
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'Bullying and Harassment', 'content' => '<ul style="padding-left: 20px;"><li>Safeguarding Team<br>safeguarding@lincolncollege.ac.uk<br>01522 86495 or 01522 864219<br>during office hours<br>&nbsp;</li><li>Out of hours duty emergency teams<br>01522 782333 (Lincolnshire)<br>03004 564546 (Nottinghamshire)</li></ul>', 'visible' => 'Y'],
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'PREVENT', 'content' => '<ul style="padding-left: 20px;"><li>Safeguarding Team<br>safeguarding@lincolncollege.ac.uk<br>01522 86495 or 01522 864219<br>during office hours<br>&nbsp;</li><li>Out of hours duty emergency teams<br>01522 782333 (Lincolnshire)<br>03004 564546 (Nottinghamshire)<br>&nbsp;</li><li>Lincolnshire or Nottinghamshire Police<br>Telephone 101 to report a crime<br>Telephone 999 in an emergency</li></ul>', 'visible' => 'Y'],
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'Mental Health', 'content' => '<ul style="padding-left: 20px;"><li>Assessment Team<br>assessmentofficer@lincolncollege.ac.uk<br>01522 876225<br>during office hours<br>&nbsp;</li></ul>', 'visible' => 'Y'],
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'Counselling', 'content' => '<ul style="padding-left: 20px;"><li>Student Services<br>studentservices@lincolncollege.ac.uk<br>01522 876220<br>during office hours<br>&nbsp;</li></ul>', 'visible' => 'Y'],
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'Welfare', 'content' => '<ul style="padding-left: 20px;"><li>Welfare Team<br>welfare@lincolncollege.ac.uk<br>01522 876220<br>during office hours<br>&nbsp;</li></ul>', 'visible' => 'Y'],
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'Additional Learning Support', 'content' => '<ul style="padding-left: 20px;"><li>Assessment Team<br>assessmentofficer@lincolncollege.ac.uk<br>01522 876225<br>during office hours<br>&nbsp;</li></ul>', 'visible' => 'Y'],
            ['created_at' => date("Y-m-d H:i:s"), 'source' => 8, 'title' => 'Youth and Wellbeing', 'content' => '<ul style="padding-left: 20px;"><li>Youth and Wellbeing Team<br>youthworker<br>@lincolncollege.ac.uk<br>01522 876220<br>during office hours<br>&nbsp;</li></ul>', 'visible' => 'Y']
        ]);
