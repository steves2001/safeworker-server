...
Route::post('login', 'API\UserController@login')->name('studentLogin');
Route::post('login/staff', 'API\UserController@login')->name('staffLogin');
...
Route::group(['middleware' => 'auth:api'], function(){
    ...
    Route::post('announcement/submit/security', 'API\AnnouncementController@submitAnnouncement')->middleware(['role:Admin+Editor+Security'])->name('Security');
    ...
    Route::get('activities', 'API\ActivityController@index')->middleware(['role:Admin']);
    Route::post('activities/chart/activity', 'API\ActivityController@chartActivity')->middleware(['role:Admin']);
